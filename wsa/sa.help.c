...
void saHelp (void)
{
  fprintf (stderr,
    ...
    "  magic2 -x <IDX> { -i <reads> | -I <rConfig> } -o <outDir> [options]\n"
    "  magic2 --sraDownload <SRR,...> [--fastq] [--split_pairs] [--maxGB <float>]\n"
    "  magic2 -h | --help | --devhelp | --version\n"
    "\n"
  ) ;

  fprintf (stderr,
    "Quick examples:\n"
    "  # Build index just from a raw genome sequance once, then align\n"
    ...
    "  magic2 -x IDX -i SRR24511885 -o results/ --bam --full\n"
    "\n"
    "  # Download runs from SRA and store locally in preferred format , do not align\n"
    "  magic2 --sraDownload <SRR,...> [--fastq] [--split_pairs] [--maxGB <float>]\n"
    "\n"
    "  # Quick QC survey across several SRA runs (no alignment files written)\n"
    "  magic2 -x IDX -i SRR001,SRR002,SRR003 --no_ali -o qc/\n"
    "\n"
  ...
  fprintf (stderr,
    ...
    "    T  transposons.fasta.gz     Transposons\n"
    ...
    "    A  annotation.gtf.gz        Gene annotation: GTF, GFF/GFF3, or .introns\n"
    "  Notes:\n"
    "    The letter in the first column is used by the program, it must belong to this list\n"
    "    The file names in column 2 are not constrained, choose what you want\n"
    "    The target names in the annotation I files must exist in one of the G,M,C files\n"
    "    Multiple lines of the same type are allowed, for examples chromosomes can be in separate files.\n"
    "\n"
  ) ;
  ...
  fprintf (stderr,
    ...
    "                             RAM and CPU cost.\n"
    "                             The alignment seed step is set automatically to the same value.\n"
  ...
  fprintf (stderr,
    ...
    "    -i accepts a list of files, or of paired-end pair, or SRR ids ; options come from the command line.\n"
    "    -I accepts a run manifest file; options are specified per sample within the file.\n"
    "\n"
    "  -i <FILE or R1+R2>       A coma delimited list of input files, or a paired-end pair joined with +.\n"
    ...
    "                             For multiple files or samples, prefer  -I instead.\n"
    "\n"
    ...
    "                                       For SRA runs, the SRR identifier (i.e. SRR1234)\n"	   
    ...
    "                                       Adaptor1=<seq>      read-1 exit adaptor [default: auto-detected]\n"
    "                                       Adaptor2=<seq>      read-2 exit adaptor [default: auto-detected]\n"
    "                                       species=worm        worm case: report trans-spliced leaders SL1-12\n"
    ...
    "                               lib4.fastq.gz                      sample_C  species=worm\n"
    ...
    "    --maxGB <float>        Stop after downloading FLOAT gigabases [default: unlimited]\n"
  ...
  fprintf (stderr,
    ...
    "                             used as-is.\n"
    "  --hits                   Export alignments in Magic .hits.gz format [default]\n"
    "                             (explicit mismatches, introns, and overhang details)\n"
    "  --tabular                Export alignments in tabular (Magic-BLAST) format\n"
    "  --sam                    Export alignments in SAM format\n"
    "  --bam                    Export alignments in BAM format if samtools is available, if not in SAM\n"
  ...
  fprintf (stderr,
    ...
    "                             [default: 4], 8 is a good value for illumina reads\n"
  ...
  fprintf (stderr,
    ...
    "------------------------------------------------------------\n"
    "  --step <INT>             Seed step during alignment [default: index step]\n"
  ...
  fprintf (stderr,
    ...
    "\n"
    "  To process multiple runs in parallel, enter a -i .ist, or -I manifiest\n"
    "  You may also launch independent magic2 processes with a few seconds delay.\n"
    "  The target index is memory-mapped and shared at no extra RAM cost.\n"
    "  and on a large server each instance will run on a different numa-node\n"
    "\n"
  ) ;
  ...
  fprintf (stderr,
    ...
    "\n"
    "Boratyn G, Thierry-Mieg J, Thierry-Mieg D, Busby B and Madden T:\n"
    "Magic-BLAST, an accurate RNA-seq aligner for long and short reads\n"
    "BMC Bioinformatics, 20,1,405,2019.\n"
    "\n"	   
  ) ;
  exit (0) ;
}
...
void saDevHelp (void)
{
  ...
  fprintf (stderr,
    ...
    "  --nBlocks, --nB <INT>    Simultaneous data blocks in the pipeline [default: 3/2 * nCPU]\n"
  ...
  fprintf (stderr,
    ...
    "READ ALIGNMENT TUNING\n"
    "------------------------------------------------------------\n"
    "  --iStep <INT>            Seed step during read alignment [default: index step]\n"
  ...
  fprintf (stderr,
	   ...
	   "  topology. \n"
	   "  Because of re-spawning, attaching gdb to the initial process and\n"
    ...
    "                             step-by-step debugging. Some verbose diagnostic messages\n"
