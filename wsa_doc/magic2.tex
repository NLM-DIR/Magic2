...
E-mail: boratyng@ncbi.nlm.nih.gov \\[2mm]
%\end{center}
...
\begin{abstract}
  Magic2 is a system to analyze long and short RNA deep sequencing.
The program is easy to use because the 
  -seq 
