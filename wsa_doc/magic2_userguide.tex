...
a meaningful sample name and to associate several data files to
...
By default, the file format is implied by the file suffix: .fasta, .fastq, .fastc.
...
whereas \code{sample\_B} and \code{sample\_C} are independent runs.
